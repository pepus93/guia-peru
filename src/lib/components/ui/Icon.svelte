<script context="module" lang="ts">
  export type IconName =
    | 'alert-circle' | 'alert-triangle' | 'arrow-left-right'
    | 'bed' | 'bug' | 'bus'
...
<script lang="ts">
  ...
  const paths: Record<IconName, string> = {
    ...
    'car':              `<path d="M3 9H1v7a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V9h-2"/><path d="M4 9l2-5h12l2 5"/><circle cx="7.5" cy="15.5" r="1.5"/><circle cx="16.5" cy="15.5" r="1.5"/>`,
    ...
    'phone':            `<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.36 10a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.11 0h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.09 7.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>`,
    ...
    'utensils':         `<path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3"/><path d="M21 15v7"/>`,
